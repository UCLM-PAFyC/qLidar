...
class qLidar:
    ...
    def __init__(self, iface):
        ...
        self.current_plugin_name = qLidarDefinitions.CONST_SETTINGS_PLUGIN_NAME
        ...
        self.actions = []
        self.menu = self.tr(u'&qLidar')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'qLidar')
        self.toolbar.setObjectName(u'qLidar')

        #print "** INITIALIZING qLidar"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('qLidar', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qLidar/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'qLidar'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.dockwidget == None:
            ...
            self.dockwidget = qLidarDockWidget(self.iface,
